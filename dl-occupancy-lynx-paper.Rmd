...
```{r figure2, eval = F, fig.cap="**Figure 2**: Detections (turquoise) and non-detections (fushia) for each of the 3 species lynx, chamois and roe deer. Sites are on the Y axis, while sampling occasions are on the X axis."}
## Occupancy analyses
