---
title: "Do  deep learning for species identification to infer predator-prey co-occurrence: Reproducible `R` workflow integrating models in computer vision and ecological statistics"
...
#list.of.packages <- c("unmarked")
#new.packages <- list.of.packages[!(list.of.packages %in% #installed.packages()[,"Package"])]
#if(length(new.packages)) devtools::install_github("rbchan/unmarked")
library(tidyverse)
...
perf_prediction <- hchart(dout, label = TRUE) %>%
    hc_yAxis(title = list(text = 'Actual'),
             labels = list(format = "{value} ({this.percentage}%)")) %>%
